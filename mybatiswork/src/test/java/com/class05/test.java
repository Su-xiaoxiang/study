...
//    }
    ...
    *//**
    ...
    public void test() {
        ...
        int pages = studentPageInfo.getPages(); // 共有几页数据
        long total = studentPageInfo.getTotal();// 共有多少条数据
        int pageNum = studentPageInfo.getPageNum();//当前为第几页
        int pageSize = studentPageInfo.getPageSize();// 每页显示多少条数据
    }
}
